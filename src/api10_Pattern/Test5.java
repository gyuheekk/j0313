...
public class Test5 {
	public static void main(String[] args) {
		...
		String regEx2 = "^[a-zA-Z0-9_-]{3,}@[a-zA-Z0-9]-z]+$"; 	
		String regEx3 = "^[a-zA-Z0-9_-]{3,12}@[a-zA-Z0-9]+\\+\\.[a.[a-z]+$"; 	
		...
		String str15 = "_at-om@na_ver1234.co.kr";
		String str16 = "atom@naver.com";
		...
		System.out.println("9:16= " + Pattern.matches(regEx9, str16));
		System.out.println();
	}
}
