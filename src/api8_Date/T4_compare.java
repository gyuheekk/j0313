...
public class T4_compare {
	public static void main(String[] args) {
		...
		// 날짜와 시간 구분하기(T문자를 기준으로 spilt()메소드 이용하여 자르기)
...
//		String bigyoToday = strTempToday.substring(0,strTempToday.indexOf("."));
		...
		// 날짜를 날짜형식으로 비교하고자 한다면? isEqual(): 동일날짜비교, isBefore(): 이전날짜비교, isAfter(): 이후날짜비교, Period: 날짜차이
...
//		LocalDate bigyiDate2 = LocalDate.parse(lastDay, DateTimeFormatter.ofPattern("yyyy-MM-dd"));
//		System.out.println(lastDay + " 달의 마지막 일자? " + YearMonth.from(bigyiDate2).atEndOfMonth());
		
		String lastDay2 = "24-03-10";
